...
TOOL_DESCRIPTION = (
    ...
    # "Пример вызова: rag.search({\"query\":\"модель данных\",\"k\":5,\"filters\":null,\"rerank\":false,\"top_n\":null}) "
    "Когда требуется инструмент, не печатай пример и не оборачивай в кодовые блоки — верни вызов инструмента."
)
